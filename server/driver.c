...
DriverSymbols driver_symbols[] = {
	...
	{ "get_keypad_brightness",  offsetof(Driver, get_keypad_brightness),    0 },
	{ "set_keypad_brightness",  offsetof(Driver, set_keypad_brightness),    0 },
	{ "backlight",              offsetof(Driver, backlight),                0 },
	{ "keypad_backlight",       offsetof(Driver, keypad_backlight),         0 },
	{ "set_backlight_color",    offsetof(Driver, set_backlight_color),      0 },
	{ "get_backlight_color",    offsetof(Driver, get_backlight_color),      0 },
